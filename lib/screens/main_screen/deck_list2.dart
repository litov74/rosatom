...
class DeckListScreen2 extends StatefulWidget {
  static const String TAG = "DeckListScreen";

  @override
  State<StatefulWidget> createState() => DeckListScreenState2();
}

class DeckListScreenState2 extends State<DeckListScreen2> {
          ...
          actions: [
            Padding(
              ...
              child: GestureDetector(
                ...
                onTap: () {
                  showBottomSheetGame(context, DeckListScreen2.TAG);
                },
              ),
            ),
          ],
