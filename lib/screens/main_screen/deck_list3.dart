...
class DeckListScreen3 extends StatefulWidget {
  static const String TAG = "DeckListScreen";

  @override
  State<StatefulWidget> createState() => DeckListScreenState3();
}

class DeckListScreenState3 extends State<DeckListScreen3> {
          ...
          actions: [
            Padding(
              ...
              child: GestureDetector(
                ...
                onTap: () {
                  showBottomSheetGame(context, DeckListScreen3.TAG);
                },
              ),
            ),
          ],
  ...
  List<Widget> generateList(List<Deck> decks) {
    var sorted = decks.where((element) => (element.title.contains("Устойчивое развитие.\n")));
